                    ...
                    if (fn.attributes.toolboxParentArgument) {
                        ...
                        if (!parentInput) {
                            ...
                            for (const param of parentInfo.parameters) {
                                if (parent.querySelector(`field[name=${param.definitionName}]`))
                                    continue;
                                parentInput = document.createElement("value");
...
(function (pxt) {
    ...
    (function (blocks) {
        ...
        function blockSetToRequiredBlockCounts(blockSet) {
        ...
        function validateProject(usedBlocks, rubric) {
            const rubricData = blocks.parseRubric(rubric);
            const finalResult = {};
            rubricData.criteria.forEach((criteria) => {
                criteria.blockRequirements.forEach((blockSet) => {
            ...
            return { blockIdResults: finalResult };
        }
        blocks.validateProject = validateProject;
        function validateBlockSet(usedBlocks, blockSet) {
            ...
            const { missingBlocks, disabledBlocks, insufficientBlocks } = pxt.blocks.validateBlocksExist({
        ...
        showEditor_() {
            ...
            switch (this.asset.type) {
                ...
                case "tilemap" /* pxt.AssetType.Tilemap */:
                    ...
                    for (const tile of pxtblockly.getTilesReferencedByTilesets(this.sourceBlock_.workspace)) {
...
(function (pxtblockly) {
    ...
    pxtblockly.getTilesReferencedByTilesets = getTilesReferencedByTilesets;
